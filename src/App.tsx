...
const LeavePlanningWizardPage  = lazy(() => import('./pages/LeavePlanningWizardPage'));
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/coverage/planning" element={
          <ProtectedRoute minRole="companyCommander"><LeavePlanningWizardPage /></ProtectedRoute>
        } />
