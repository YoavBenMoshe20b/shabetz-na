// AlertsButton — bell icon with a critical-count badge.
//
// Drops into a header/hero. Click opens AlertsSheet. Badge appears only
// when there are critical or warning alerts; info-only state is silent.
  ...
  return (
    <>
      <button
        ...
        aria-label={`התראות${count.total > 0 ? ` · ${count.total}` : ''}`}
      >
